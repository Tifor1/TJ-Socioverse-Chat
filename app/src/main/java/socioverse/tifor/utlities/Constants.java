    ...
    public static HashMap<String, String> getRemoteMsgHeaders() {
        ...
        if (remoteMsgHeaders == null) {
            ...
            remoteMsgHeaders.put(REMOTE_MSG_AUTHORIZATION,
                    "key=AAAAiq-kvyQ:APA91bFSxdPEg869MvqzVlDlIFoBzhWdtHt-DQDjuw2UgcsjiaYo1XBU9KYl_AviVvdSHiPn84uwGWJHD66GHA6lPGSMYhsLUh7jnEvcf7UsyPHP5R1-CMEybNU2IqSilYIgEN0xbLPL");
